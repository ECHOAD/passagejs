    ...
    namespace mint {
        const v1beta1: {
            ...
            QueryParamsRequest: {
                ...
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _90.QueryParamsRequest;
                fromPartial(_: import("../helpers").DeepPartial<_90.QueryParamsRequest>): _90.QueryParamsRequest;
            };
            QueryParamsResponse: {
                encode(message: _90.QueryParamsResponse, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _90.QueryParamsResponse;
                fromPartial(object: import("../helpers").DeepPartial<_90.QueryParamsResponse>): _90.QueryParamsResponse;
            };
            QueryAnnualProvisionsRequest: {
                encode(_: _90.QueryAnnualProvisionsRequest, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _90.QueryAnnualProvisionsRequest;
                fromPartial(_: import("../helpers").DeepPartial<_90.QueryAnnualProvisionsRequest>): _90.QueryAnnualProvisionsRequest;
            };
            QueryAnnualProvisionsResponse: {
                encode(message: _90.QueryAnnualProvisionsResponse, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _90.QueryAnnualProvisionsResponse;
                fromPartial(object: import("../helpers").DeepPartial<_90.QueryAnnualProvisionsResponse>): _90.QueryAnnualProvisionsResponse;
            };
            Minter: {
                encode(message: _89.Minter, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _89.Minter;
                fromPartial(object: import("../helpers").DeepPartial<_89.Minter>): _89.Minter;
            };
            Params: {
                encode(message: _89.Params, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: import("protobufjs").Reader | Uint8Array, length?: number): _89.Params;
                fromPartial(object: import("../helpers").DeepPartial<_89.Params>): _89.Params;
            };
            GenesisState: {
                ...
                fromPartial(object: import("../helpers").DeepPartial<_88.GenesisState>): _88.GenesisState;
            };
        };
    }
    const ClientFactory: {
