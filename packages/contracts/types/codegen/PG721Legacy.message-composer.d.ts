...
import { Expiration, Metadata, Binary } from "./PG721Legacy.types";
export interface PG721LegacyMsg {
...
export declare class PG721LegacyMsgComposer implements PG721LegacyMsg {
    sender: string;
    contractAddress: string;
